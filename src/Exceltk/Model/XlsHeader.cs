...
namespace ExcelToolKit.BinaryFormat {
    ...
    internal class XlsHeader {
        ...
        public ulong Signature {
            get {
                return BitConverter.ToUInt64(m_bytes, 0x0);
            }
        }
        ...
        public bool IsSignatureValid {
            get {
                return (Signature==0xE11AB1A1E011CFD0);
            }
        }
        ...
        public ushort Version {
            get {
                return BitConverter.ToUInt16(m_bytes, 0x18);
            }
        }
        ...
        public ushort DllVersion {
            get {
                return BitConverter.ToUInt16(m_bytes, 0x1A);
            }
        }
        ...
        public ushort ByteOrder {
            get {
                return BitConverter.ToUInt16(m_bytes, 0x1C);
            }
        }
        ...
        public int SectorSize {
            get {
                return (1<<BitConverter.ToUInt16(m_bytes, 0x1E));
            }
        }
        ...
        public int MiniSectorSize {
            get {
                return (1<<BitConverter.ToUInt16(m_bytes, 0x20));
            }
        }
        ...
        public int FatSectorCount {
            get {
                return BitConverter.ToInt32(m_bytes, 0x2C);
            }
        }
        ...
        public uint RootDirectoryEntryStart {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x30);
            }
        }
        ...
        public uint TransactionSignature {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x34);
            }
        }
        ...
        public uint MiniStreamCutoff {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x38);
            }
        }
        ...
        public uint MiniFatFirstSector {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x3C);
            }
        }
        ...
        public int MiniFatSectorCount {
            get {
                return BitConverter.ToInt32(m_bytes, 0x40);
            }
        }
        ...
        public uint DifFirstSector {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x44);
            }
        }
        ...
        public int DifSectorCount {
            get {
                return BitConverter.ToInt32(m_bytes, 0x48);
            }
        }
