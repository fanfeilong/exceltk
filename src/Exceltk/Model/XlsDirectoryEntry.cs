...
namespace ExcelToolKit.BinaryFormat {
    ...
    internal class XlsDirectoryEntry {
        ...
        public string EntryName {
            get {
                return Encoding.Unicode.GetString(m_bytes, 0x0, EntryLength).TrimEnd('\0');
            }
        }
        ...
        public ushort EntryLength {
            get {
                return BitConverter.ToUInt16(m_bytes, 0x40);
            }
        }
        ...
        public STGTY EntryType {
            get {
                return (STGTY)Buffer.GetByte(m_bytes, 0x42);
            }
        }
        ...
        public DECOLOR EntryColor {
            get {
                return (DECOLOR)Buffer.GetByte(m_bytes, 0x43);
            }
        }
        ...
        public uint RightSiblingSid {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x48);
            }
        }
        ...
        public uint ChildSid {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x4C);
            }
        }
        ...
        public uint UserFlags {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x60);
            }
        }
        ...
        public DateTime CreationTime {
            get {
                return DateTime.FromFileTime(BitConverter.ToInt64(m_bytes, 0x64));
            }
        }
        ...
        public DateTime LastWriteTime {
            get {
                return DateTime.FromFileTime(BitConverter.ToInt64(m_bytes, 0x6C));
            }
        }
        ...
        public uint StreamFirstSector {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x74);
            }
        }
        ...
        public uint StreamSize {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x78);
            }
        }
        ...
        public uint PropType {
            get {
                return BitConverter.ToUInt32(m_bytes, 0x7C);
            }
        }
    }
}