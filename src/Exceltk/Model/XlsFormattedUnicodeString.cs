...
namespace ExcelToolKit.BinaryFormat {
    ...
    internal class XlsFormattedUnicodeString {
        ...
        public bool HasExtString {
            get {
                return ((Flags&FormattedUnicodeStringFlags.HasExtendedString)==
        ...
        private uint ByteCount {
            get {
                return (uint)(CharacterCount*((IsMultiByte)?2:1));
            }
        }
        ...
        public uint HeadSize {
            get {
                return (uint)((HasFormatting)?2:0)+(uint)((HasExtString)?4:0)+3;
            }
        }
