...
namespace Exceltk.Reader.Binary {
    ...
    internal class XlsBiffFormulaCell : XlsBiffNumberCell {
        ...
        public FormulaFlags Flags {
            get {
                return (FormulaFlags)(base.ReadUInt16(0xE));
            }
        }
                    ...
                    switch (type) {
                        case 0: // String
                            ...
                            if (rec.ID==BIFFRECORDTYPE.SHRFMLA)
                                str=
                                    GetRecord(m_bytes, (uint)(Offset+Size+rec.Size), reader) as
        ...
        public string Formula {
            get {
                ...
                return Exceltk.Extension.DefaultEncoding().GetString(bts, 0, bts.Length);
            }
        }
    }
}